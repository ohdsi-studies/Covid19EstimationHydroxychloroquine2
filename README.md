OHDSI COVID-19 Studyathon: Hydroxychloroquine population-level effect estimation 2
=============
...
- Study start date: **May 31, 2020**
- Study end date: **-**
- Protocol: **[PDF (as filed with PASS)](https://github.com/ohdsi-studies/Covid19EstimationHydroxychloroquine2/tree/master/documents)**
- Publications: **-**
- Results explorer: **[Shiny app](https://data.ohdsi.org/Covid19EstimationHydroxychloroquine2/)**
...
2. In 'R', use the following code to install the Covid19EstimationHydroxychloroquine2 package:

  ```r
  devtools::install_github("ohdsi-studies/Covid19EstimationHydroxychloroquine2")
  ```
...
3. Once installed, you can execute the study by modifying and using the following code:
  ...
  outputFolder <- "c:/Covid19EstimationHydroxychloroquine2"
...
* We use the <a href="https://github.com/OHDSI/Covid19EstimationHydroxychloroquine2/issues">GitHub issue tracker</a> for all bugs/issues/enhancements
  
License
=======
The Covid19EstimationHydroxychloroquine2 package is licensed under Apache License 2.0
